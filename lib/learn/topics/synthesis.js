...
export const SYNTHESIS_CHAPTERS = [
    {
        ...
        examAnchor: {
            question: 'A producer needs a hollow, clarinet-like synth tone. Explain why the choice of oscillator waveform matters, and state which waveform is the best starting point, referring to harmonic content.',
            modelPoints: [
                'Timbre is determined by harmonic content, not the fundamental — two waveforms can share the same fundamental frequency and still sound completely different because the harmonics stacked above it differ.',
                'A sawtooth wave contains all harmonics, giving it a bright, buzzy character — not the hollow quality wanted here.',
                'A square wave contains only odd harmonics, which gives it the hollow, reedy quality that matches a clarinet — making it the best starting point.',
                'A sine wave has no harmonics at all, so there is no harmonic content to shape — it cannot be turned into a clarinet-like tone.',
            ],
            examTip: 'Name the harmonic content explicitly. Stating "square sounds hollow" without saying why — that it contains only odd harmonics — drops the mark; the mechanism has to be in the answer, not just the outcome.',
        },
        ...
        rows: [
            {
                ...
                audio: { preset: 'waveform-sine', label: 'Play to hear a pure sine tone' },
                assessment: {
                    id: 'what-is-sound',
            ...
            },
            {
                ...
                audio: { preset: 'waveform-sawtooth', label: 'Play to hear a sawtooth' },
                assessment: {
                    id: 'four-waveforms',
    ...
    },
    {
        ...
        rows: [
            ...
            },
            {
                ...
                audio: { preset: 'filter-sweep', label: 'Play to hear a filter sweep' },
    ...
    },
    {
        ...
        description: 'How ADSR envelopes shape amplitude and filter cutoff over time to give a patch movement and character.',
        estimatedTime: '10–15 minutes',
        examAnchor: {
        ...
        rows: [
            ...
            },
            {
                ...
                audio: { preset: 'adsr-pluck', label: 'Play to hear a plucky envelope' },
            ...
            },
            {
                ...
                audio: { preset: 'adsr-swell', label: 'Play to hear a slow swell' },
                assessment: {
                    id: 'filter-envelope',
    ...
    },
    {
        ...
        rows: [
            ...
            },
            {
                ...
                audio: { preset: 'lfo-vibrato', label: 'Play to hear vibrato' },
                assessment: {
                    id: 'lfo-targets',
        ...
        rows: [
            {
                ...
                audio: { preset: 'fm-ratio', label: 'Play to hear FM' },
                assessment: {
                    id: 'carrier-and-modulator',
            ...
            },
            {
                ...
                description: 'FM synthesis is prized for sounds subtractive struggles with: glassy electric pianos, shimmering bells, and punchy, clangy basses — all built from sideband content a filter can\'t create from scratch. The 1980s DX7 made electric-piano and bell FM patches famous, and a modern FM synth in any DAW is the exam-relevant place to build them.',
                animation: 'fm-in-practice',
                assessment: {
                    id: 'fm-in-practice',
                    question: 'An exam question asks a student to justify why they chose FM synthesis (using an FM synth) rather than subtractive synthesis for an electric-piano-style patch. Which answer best justifies the choice, in mark-scheme language?',
                    options: [
                        ...
                        { text: 'FM is chosen because it needs only one oscillator, which is simpler to program than a subtractive synth', correct: false, feedback: 'Most FM synths give you several operators, not one — and the justification for choosing FM is about the resulting timbre, not the interface being simpler.' },
                    ],
                },
            },
        ],
