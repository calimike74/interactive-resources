        ...
        rows: [
            {
                ...
                audio: { preset: 'verb-hall', label: 'Hold to hear the tick strike, then the hall answer — direct sound, early reflections and tail arriving in order.' },
                assessment: {
                    id: 'direct-early-tail',
            ...
            },
            {
                ...
                audio: { preset: 'verb-predelay', label: 'Hold to hear the same hall with an 80 ms gap before the room answers — pre-delay, not an echo.' },
                assessment: {
                    id: 'pre-delay-gap',
            ...
            },
            {
                ...
                audio: { preset: 'verb-dry', label: 'Hold to hear the tick almost entirely dry — the up-close reference, before the R/D ratio rises with distance.' },
                assessment: {
                    id: 'distance-rd-ratio',
        ...
        rows: [
            {
                ...
                audio: { preset: 'verb-room', label: 'Hold to hear the small room\'s 0.4 s tail — a short RT60, the decay already gone before the next tick.' },
                assessment: {
                    id: 'rt60-decay',
