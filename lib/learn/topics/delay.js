// Delay Course — 4-chapter version (Task 9/11, learn-rollout-wave1).
...
// single/multi-tap, slapback, timed delay, ping-pong, and ADT.
// Legacy rows (what-delay-does, delay-time, feedback-repeats, slapback,
// timed-delay, ping-pong, delay-pan-eq, adt) are copied verbatim from the
// former single-lesson DELAY_TOPIC (removed in Task 11, same pattern Task 5
// used for EQ_TOPIC/EQ_CHAPTERS): same heading/description/animation/
        ...
        rows: [
            {
                ...
                audio: { preset: 'delay-single', label: 'Play to hear one clean repeat sit quietly behind the dry pluck: no feedback, just one echo.' },
                assessment: {
                    id: 'what-delay-does',
    ...
    },
    {
        ...
        examAnchor: {
            ...
            modelPoints: [
                ...
                'ADT uses a short delay of 15–30 ms (up to about 40 ms for vocals), with zero feedback: a single repeat short enough to blend into the dry vocal as one thicker voice, rather than reading as a separate echo.',
        ...
        rows: [
            {
                ...
                animation: 'ping-pong',
                audio: { preset: 'delay-pingpong', label: 'Play to hear repeats bounce hard left then right as feedback keeps the pattern alive.' },
                assessment: {
                    id: 'ping-pong',
