...
export const DISTORTION_CHAPTERS = [
    {
        ...
        rows: [
            ...
            },
            {
                ...
                interactive: 'drive',
                audio: { preset: 'dist-drive', label: 'Play to hear a rich tone through a fixed drive — soft-clip warmth, sitting at the top of the "warm" zone before things turn harsh.' },
                assessment: {
                    id: 'drive-tone-level',
