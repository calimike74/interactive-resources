...
import { DISTORTION_CHAPTERS } from './distortion.js';
import { MIDI_CHAPTERS } from './midi.js';
import { SOFTWARE_HARDWARE_CHAPTERS } from './software-hardware.js';
import { DIGITAL_ANALOGUE_CHAPTERS } from './digital-analogue.js';
import { NUMERACY_CHAPTERS } from './numeracy.js';
import { LEADS_AND_SIGNALS_CHAPTERS } from './leads-and-signals.js';
...
const learnTopics = {
    ...
    distortion: DISTORTION_CHAPTERS,
    midi: MIDI_CHAPTERS,
    'software-hardware': SOFTWARE_HARDWARE_CHAPTERS,
    'digital-analogue': DIGITAL_ANALOGUE_CHAPTERS,
    numeracy: NUMERACY_CHAPTERS,
    'leads-and-signals': LEADS_AND_SIGNALS_CHAPTERS,
};
...
const learnRationales = {
    ...
    'software-hardware': 'Past papers touch software and hardware lightly: signal flow, converters, buffer size. This chapter covers the essentials.',
