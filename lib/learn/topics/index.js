import { EQ_TOPIC } from './eq.js';
import { SYNTHESIS_TOPIC } from './synthesis.js';
import { COMPRESSION_TOPIC } from './compression.js';
import { DELAY_TOPIC } from './delay.js';
    ...
    eq: [
        {
            ...
            description: 'Watch a cinematic overview of equalization — filter types, graphic vs parametric EQ, and Q factor explained visually. Take notes as you watch.',
