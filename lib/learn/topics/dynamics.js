...
export const DYNAMICS_CHAPTERS = [
    {
        ...
        rows: [
            ...
            // --- new row ---
            {
                ...
                audio: { preset: 'comp-drums-raw', label: 'Play to hear the raw drum loop — kick and snare swinging freely between quiet and loud.' },
                assessment: {
                    id: 'defining-dynamic-range',
            ...
            // --- new row ---
            {
                ...
                audio: { preset: 'comp-drums-squashed', label: 'Play to hear the same loop compressed — peaks tamed, level lifted, one consistent groove.' },
                assessment: {
                    id: 'automatic-fader',
