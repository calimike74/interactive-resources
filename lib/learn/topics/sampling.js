        ...
        rows: [
            {
                ...
                audio: { preset: 'smp-full-depth', label: 'Hold to hear the tone at full rate and full depth — the clean reference the crushed staircase later compares against.' },
                assessment: {
                    id: 'sample-rate-nyquist',
            ...
            },
            {
                ...
                audio: { preset: 'smp-crushed', label: 'Hold to hear the same tone quantised to roughly 4 bits — a coarse staircase, audible as gritty quantisation noise.' },
                assessment: {
                    id: 'bit-depth-staircase',
        ...
        rows: [
            {
                ...
                audio: { preset: 'smp-loop-click', label: 'Hold to hear a loop point sitting off a zero crossing — the phase jump ticks audibly on every repeat.' },
                assessment: {
                    id: 'clicks-zero-crossings',
            ...
            },
            {
                ...
                audio: { preset: 'smp-loop-clean', label: 'Hold to hear the same loop with its point fixed on a zero crossing — the join now silent.' },
                assessment: {
                    id: 'loop-points-stutter',
        ...
        rows: [
            {
                ...
                audio: { preset: 'smp-forward', label: 'Hold to hear a struck tone looped forward — sharp attack, decay, then silence before the next hit.' },
                assessment: {
                    id: 'repitch-stretch-shift',
            ...
            },
            {
                ...
                audio: { preset: 'smp-reversed', label: 'Hold to hear the exact same samples reversed — the decay becomes a swell that grows into a sudden stop.' },
                assessment: {
                    id: 'reverse-swell',
