...
const NUMERACY_EXPANSIONS = [
  ...
  // −60 dBFS is an invented illustrative value, not sourced from a named
  // file — flagged in the task report
  { trigger: "a floor at −60 dBFS gives 60 dB of range", content: "This −60 dBFS figure is an illustrative example, not a fixed exam value — real noise floors vary by equipment. What is fixed is the method: dynamic range = ceiling − noise floor, always a subtraction in dB. The Digital & Analogue course's Crossing the Line chapter reaches a dynamic-range figure a different way — from bit depth, roughly 6 dB per bit — a related number worked out from a different starting point, not a duplicate of this one." },
