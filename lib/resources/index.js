...
import waveformDrawingAssessment from './waveform-drawing-assessment';
import bpmDelayCalculator from './bpm-delay-calculator';
import midiBinaryAssessment from './midi-binary-assessment';
import digitalAudioAssessment from './digital-audio-assessment';
import pitchSynthMonitorsAssessment from './pitch-synth-monitors-assessment';
import levelsMeteringAssessment from './levels-metering-assessment';
import acousticsPsychoacoustics from './acoustics-psychoacoustics';
import mixingProduction from './mixing-production';
