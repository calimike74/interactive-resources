...
export const DEPTH_LINES = {
    core: 'the bench names what you are hearing and tells you what to try, one control at a time. The stage is the loop against the beat: before, after, and what is taken off.',
    alevel: "the bench now judges the control you touch the way the paper does: setting, effect on this part, verdict, change, with the half of the mark each part earns. The paper's drawing opens on the stage: drag inside it to read a level off.",
    extension: 'the bench opens the machine: what the gain computer asks for against what attack and release let it apply, the dot leaving the curve by that lag, and why the numbers are the numbers.',
};
