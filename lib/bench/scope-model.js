...
// The four shapes first, then the recordings (Mike, 8 Sep 2026): a student's
// first screen is a sine wave, and the row reads sine, square, saw, triangle.
export const SOURCE_IDS = ['sine', 'square', 'saw', 'triangle', 'cello', 'bass', 'voice'];
...
function baseState() {
    return {
        ...
        task: null,
        presetId: null,
        volume: 0.5, // the output slider at halfway (Mike, 8 Sep 2026: 0.8 was too loud)
    };
}
...
// The first screen is a sine wave with no preset chosen (Mike, 8 Sep 2026):
// the shape before the papers. A real note is one press away.
