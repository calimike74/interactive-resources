...
export const PRESETS = [
    ...
    // The 2023 paper's Q6 vocal delay (9MT0/04): tempo-synced at a quaver at
    // 120 BPM, feedback high, repeats behind the dry, a high cut, two sides a
    // few milliseconds apart. Values from the Principal Examiner's report and
    // the credited exemplar script; the bench has one time for both sides.
    {
        id: 'paper2023',
        name: '2023 paper',
        blurb: "The paper's rock-vocal delay: a quaver at 120 BPM, feedback high, 25% wet, high cut, two sides. Judge it.",
        state: { sync: true, noteId: 'eighth', bpm: 120, feedback: 80, mix: 25, highCut: 33, stereo: 'pingpong', source: 'vocal' },
    },
];
