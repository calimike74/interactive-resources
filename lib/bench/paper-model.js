...
export const TASKS = {
    lower2023: {
        id: 'lower2023', name: '2023: an octave lower', year: 2023, ref: '2023 Q2(e)',
        stem: 'On the graph below, draw a saw wave one octave lower. (The figure is part (i): a square wave with a period of 1 ms.)',
    ...
    kick2026: {
        ...
        stem: 'The initial frequency of the kick drum is about 200 Hz. Calculate the period of a 200 Hz wave in seconds.',
        want: { shape: 'any', periodMs: 5, offset: 'any' },
        marks: [{ id: 'period', words: '1/200 (1); 0.005 / 5x10-3 (1); then 5 (1)' }],
    },
    higher: {
        id: 'higher', name: 'An octave higher', year: null, ref: 'the Numeracy chapter, Drawing an Octave',
        stem: 'The graph shows a sine wave with a period of 2 ms. On the answer paper, draw the same wave one octave higher.',
        want: { shape: 'sine', periodMs: 1, offset: 'any' },
        marks: [{ id: 'shape', words: 'the same shape' }, { id: 'period', words: 'half the period: 1 ms' }],
    },
    kept: {
        id: 'kept', name: 'Judge: the period kept', year: 2023, ref: '2023 Q2(e)(ii), examiner report',
...
export const PRESETS = [
    { id: 'lower2023', name: '2023: an octave lower', task: 'lower2023', blurb: 'The 2023 drawing: a square wave with a 1 ms period is given, and the answer is a saw wave with a 2 ms period', set: { given: 'square1', timeBase: 1 } },
    { id: 'louder2025', name: '2025: louder', task: 'louder2025', blurb: 'The 2025 figure drawn louder: the same square, the same 2 ms period, a taller wave and no DC offset', set: { given: 'square2', timeBase: 1 } },
    { id: 'lower2025', name: '2025: an octave lower', task: 'lower2025', blurb: 'The same 2025 figure an octave lower: a square wave at 4 ms, the same height, no DC offset. The screen opens to 2 ms a division so two cycles fit', set: { given: 'square2', timeBase: 2 } },
    { id: 'label2024', name: '2024: label it', task: 'label2024', blurb: 'The 2024 question: a blank grid, a square wave of your own, and the bench labels the axes, the amplitude and the period the way the scheme marks them', set: { given: null, timeBase: 1 } },
    { id: 'kick2026', name: '2026: 200 Hz', task: 'kick2026', blurb: 'The 2026 kick drum: draw a wave at 200 Hz. The bench reads the period back in ms and in seconds', set: { given: null, timeBase: 2 } },
    { id: 'higher', name: 'An octave higher', task: 'higher', blurb: 'The chapter\'s own exercise: a 2 ms sine is given, and an octave higher halves the period to 1 ms', set: { given: 'sine2', timeBase: 1 } },
    { id: 'kept', name: 'Judge: the period kept', task: 'kept', blurb: 'The error the 2023 report names most often: the right shape at the wrong period. Mark it and see where the mark goes', set: { given: 'square1', timeBase: 1, fill: { shape: 'saw', periodMs: 1, amp: 0.6, offset: 0 } } },
