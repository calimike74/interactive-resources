...
const glossary = [
    ...
    { term: 'Period', definition: 'The time for ONE complete cycle of a waveform. Measured in seconds or milliseconds. Period = 1/frequency.', resource: 'squared-paper', topic: '2.5' },
    { term: 'Frequency', definition: 'The number of complete cycles per second. Measured in Hertz (Hz). Frequency = 1/period.', resource: 'squared-paper', topic: '2.5' },
    { term: 'Octave', definition: 'A doubling or halving of frequency. Going up one octave = frequency × 2. Going down = frequency ÷ 2.', resource: 'squared-paper', topic: '2.5' },
    { term: 'Amplitude', definition: 'The strength or magnitude of a signal, shown on the vertical (Y) axis of a waveform display. Represents air pressure displacement or voltage.', resource: 'squared-paper', topic: '2.5' },
