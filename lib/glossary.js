...
export const glossary = [
    ...
    { term: 'Sine Wave', definition: 'Contains only the fundamental frequency — no harmonics. Produces a pure, smooth tone. The simplest waveform.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Triangle Wave', definition: 'Contains odd harmonics only (1st, 3rd, 5th...) at reduced amplitude. Sounds softer than a square wave — slightly hollow but warm.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Sawtooth Wave', definition: 'Contains ALL harmonics (odd and even) at decreasing amplitude. Sounds bright and buzzy — the most common starting point for subtractive synthesis.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Square Wave', definition: 'Contains only odd harmonics at higher amplitude than triangle. Sounds hollow and woody — often used for bass and pad sounds.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Low-Pass Filter', definition: 'Passes frequencies below the cutoff and attenuates those above. Sweeping the cutoff down makes the sound darker and more muffled — the most common filter in subtractive synthesis.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'High-Pass Filter', definition: 'Passes frequencies above the cutoff and attenuates those below. Makes the sound thinner and brighter. Useful for removing low-end rumble.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Band-Pass Filter', definition: 'Passes a band of frequencies around the cutoff and attenuates both sides. Creates a "nasal" or "telephone" quality at narrow bandwidth.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Resonance', definition: 'Boosts frequencies at the cutoff point, creating a peak. High resonance produces a whistling or ringing quality. At extreme values, the filter self-oscillates.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Attack', definition: 'The time it takes for the sound to rise from silence to full volume after the key is pressed. Short attack = instant punch. Long attack = slow swell.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Decay', definition: 'The time it takes for the sound to fall from the peak to the sustain level. A short decay with low sustain creates a percussive "pluck" character.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Sustain', definition: 'The level (not a time!) the sound holds at while the key remains pressed. The only ADSR parameter measured as a level, not a duration.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Release', definition: 'The time it takes for the sound to fade to silence after the key is released. Long release = notes ring out. Short release = tight cutoff.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'ADSR', definition: 'Attack, Decay, Sustain, Release — the four stages of an envelope that shapes how a sound evolves over time. Controls amplitude, filter cutoff, or other parameters.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    { term: 'Oscillator', definition: 'A component that generates a repeating waveform at a specified pitch. The raw sound source in subtractive synthesis before filtering and shaping.', resource: 'subtractive-synth-explorer', topic: '1.3' },
    ...
    { term: 'Graphic Equalizer', definition: 'An EQ where slider positions visually represent the EQ curve — what you see is what you get. Fixed frequency bands, fixed Q, only gain is adjustable.', resource: 'graphic-parametric-eq', topic: '1.11' },
...
export function getTermsByTopic(topic) {
    return glossary.filter(g => g.topic === topic);
}

// Get all terms for a specific resource
export function getTermsByResource(resourceId) {
