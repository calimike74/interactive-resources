...
const rawTopics = [
    ...
    },
    {
        ...
        resourceIds: ['synth-bench', 'additive-synth-explorer', 'operator-image-explorer', 'operator-assessment'],
        specSummary: [
    ...
    },
    {
        ...
        resourceIds: ['sequence-bench', 'piano-roll', 'midi-binary-assessment'],
        specSummary: [
    ...
    },
    {
        ...
        resourceIds: ['reverb-bench', 'reverb-image-explorer', 'reverb-assessment'],
        specSummary: [
    ...
    },
    {
        ...
        icon: 'Volume2',
        resourceIds: ['acoustics-bench', 'acoustics-flashcards'],
        specSummary: [
    ...
    },
    {
        ...
        resourceIds: ['oscilloscope', 'squared-paper', 'bpm-delay-calculator', 'waveform-drawing-assessment'],
        specSummary: [
