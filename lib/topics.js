...
const topics = [
    ...
    },
    {
        ...
        resourceIds: ['mixing-production'],
        specSummary: [
            'Balance and relative level of tracks in a mix',
            'Panning and stereo placement for width and clarity',
            'Using sends, returns and bussing for effects routing',
            'Mixdown — preparing a stereo master from a multitrack project',
        ],
    },
    {
        id: 'dynamics',
    ...
    {
        id: 'acoustics',
        name: 'Acoustics & Psychoacoustics',
        specRef: '2.1/2.2',
        description: 'The hearing system, equal-loudness contours, masking, and the acoustic behaviour of rooms.',
        icon: 'Ear',
        heroVideo: '/acoustics-hero.mp4',
        resourceIds: ['acoustics-psychoacoustics'],
        specSummary: [
            'Hearing range, threshold of hearing, threshold of pain',
            'Equal-loudness contours (Fletcher–Munson) and their mixing implications',
            'Frequency masking and temporal masking',
            'Reflection, absorption, and diffusion as acoustic treatments',
            'Bass traps, room modes, and RT60',
        ],
    },
    {
        ...
        specRef: 'C4 §C',
        description: 'Scaffolded approach to the Section C unfamiliar-extract task: listen, label, explain.',
        icon: 'Search',
        heroVideo: '/production-analysis-hero.mp4',
        resourceIds: ['production-analysis'],
        specSummary: [
            'Three-pass listen-label-explain routine for unfamiliar extracts',
            'Evidence → technique → effect framework for analytical writing',
            'Identifying production processes from listening cues',
            'Comparing two sections of an extract precisely',
            'Locating creative decisions within genre conventions',
        ],
    },
    {
        id: 'digital-analogue',
