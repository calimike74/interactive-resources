...
const rawTopics = [
    ...
    },
    {
        ...
        resourceIds: [],
        status: 'in-build',
        nearestLiveTopicId: 'pitch-rhythm-correction',
        specSummary: [
    ...
    },
    {
        ...
        resourceIds: ['compression-lab', 'compressor-explorer', 'compressor-curve-practice', 'compressor-image-explorer', 'compressor-assessment', 'gate-image-explorer', 'gate-assessment', 'rtq-dynamic-compression'],
        specSummary: [
