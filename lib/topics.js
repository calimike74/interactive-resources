...
const topics = [
    ...
    },
    {
        ...
        overview: {
            whatYoullLearn: [
                'Identify subtractive, FM, additive and wavetable synthesis by ear and by description',
                'Explain how oscillators, filters and envelopes shape a sound',
                'Recognise classic synth sounds in recordings and describe how they were made',
            ],
            examRelevance: 'Synthesis appears in Component 3 listening questions (Q1–5) and often anchors a Component 4 extended response. Expect to describe a patch you hear, or compare two synthesis methods.',
            keyWords: ['Oscillator', 'Filter', 'Envelope', 'LFO', 'ADSR', 'Cutoff', 'Resonance', 'Carrier', 'Operator', 'Patch'],
        },
    },
    {
        id: 'sampling',
