 ...
 *
 * Still open, in lib/spec-topics.js KNOWN_UNRESOLVED: `1.12 Effects` and
 * `1.12 Time-based Effects`. 1.12 covers Delay, Distortion, Modulation and
 * Reverb, so an umbrella label could mean any of them and guessing would only
 * move the error. Needs a curriculum decision.
 */
