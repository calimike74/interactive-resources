...
3. **`harmonic-colour`** — clipping creates harmonics; soft/symmetric circuits favour even harmonics (warm), hard clipping favours odd (harsh) — mine the lab's harmonic content teaching verbatim where possible. Diagram NEW **`odd-even-harmonics`** (spectrum bars).
