...
import { getNextAttemptNumber, saveQuizResponse, getQuizHistory } from '@/lib/quiz-persistence';
...
export default function RevisePageClient({ topic }) {
    ...
    useEffect(() => {
        if (student) {
            setQuestions(getQuestions(topic.id));
            ...
            {!showFeedback && (
                <button
                    ...
                    style={{
                        ...
                        background: value.trim() ? t.accent.primary : t.bg.tertiary,
