...
const quizQuestions = [
  ...
  { q: 'Which delay-based technique uses very short delay times (15\u201340 ms) to thicken a vocal without audible echoes?', options: ['Ping-pong delay', 'Slapback delay', 'ADT (Automatic Double Tracking)', 'Dub delay'], correct: 2, explanation: 'Automatic Double Tracking (ADT) uses very short delay times (typically 15\u201340 ms) with subtle pitch and timing variation to simulate a double-tracked vocal. It was pioneered at Abbey Road Studios. Slapback uses slightly longer times (40\u2013120 ms). Note that ADT is a production technique built on a short delay, rather than a distinct category of delay like slapback or ping-pong.', difficulty: 'intermediate' },
