...
const EXAMPLE_REVEALS = [
    {
        id: 'compressor-anatomy',
        title: 'Compressor Signal Flow',
        description: 'Explore the internal signal path of a compressor',
        mode: 'hotspots',
        baseImage: null, // Will use placeholder
        hotspots: [
            {
                id: 'input',
                x: 10, y: 50,
                ...
                shape: 'rect',
                label: 'Input Stage',
                description: 'Signal enters here. The input gain control sets the level before compression begins. Higher input = more signal above threshold = more compression.'
            },
            {
                id: 'threshold',
                x: 30, y: 30,
                ...
                description: 'Sets the level above which compression begins. Signals below this pass through unchanged. Lower threshold = more compression applied.'
            },
            {
                id: 'ratio',
                x: 45, y: 30,
                ...
                shape: 'circle',
                label: 'Ratio Control',
                description: 'Determines how much compression is applied. 4:1 means for every 4dB over threshold, only 1dB comes out. Higher ratios = more aggressive compression.'
            },
            {
                id: 'attack',
                x: 60, y: 30,
                ...
                shape: 'circle',
                label: 'Attack Time',
                description: 'How quickly compression engages after signal exceeds threshold. Fast attack (1-10ms) catches transients. Slow attack (30-100ms) lets transients through for punch.'
            },
            {
                id: 'release',
                x: 75, y: 30,
                ...
                shape: 'circle',
                label: 'Release Time',
                description: 'How quickly compression stops after signal drops below threshold. Too fast = pumping. Too slow = over-compressed. Aim to match the musical tempo.'
            },
            {
                id: 'makeup',
                x: 90, y: 50,
                ...
                shape: 'rect',
                label: 'Makeup Gain',
                description: 'Compression reduces level, so makeup gain restores it. Match the perceived loudness before and after compression to judge the effect accurately.'
            }
        ],
        maskShape: 'circle',
        maskSize: 80,
    ...
    {
        id: 'daw-session',
        title: 'DAW Session View',
        description: 'Discover the key areas of a typical DAW arrangement',
        mode: 'hotspots',
        baseImage: null,
        hotspots: [
            {
                ...
                shape: 'rect',
                label: 'Track List',
                description: 'Shows all tracks in your session. Each track can contain audio or MIDI data. Click to select, drag to reorder.'
            },
            {
                id: 'timeline',
                x: 25, y: 5,
                ...
                description: 'Shows bars and beats (or time). Click to position the playhead. The grid helps align clips to musical timing.'
            },
            {
                id: 'arrangement',
                x: 25, y: 20,
                width: 60, height: 60,
                shape: 'rect',
                label: 'Arrangement Area',
                description: 'The main workspace where you arrange clips. Audio appears as waveforms, MIDI as piano roll blocks. Drag to move, resize edges to trim.'
            },
            {
                id: 'transport',
                x: 30, y: 85,
                ...
                description: 'Play, stop, record, and loop controls. The tempo and time signature are usually here too. Master the keyboard shortcuts: Space = play/stop.'
            },
            {
                id: 'mixer',
                x: 85, y: 20,
                width: 12, height: 60,
                shape: 'rect',
                label: 'Mixer / Channel Strip',
                description: 'Volume faders, pan controls, and insert slots for effects. Each track has a channel strip. Use groups and sends for efficient mixing.'
            }
        ],
        maskShape: 'circle',
        maskSize: 100,
    ...
    {
        id: 'eq-bands',
        title: 'EQ Frequency Bands',
        description: 'Explore the frequency spectrum and typical EQ applications',
        mode: 'hotspots',
        baseImage: null,
        hotspots: [
            {
                ...
                description: 'Felt more than heard. Kick drum thump, bass weight. Too much = muddy. High-pass filter here on most tracks except kick and bass.'
            },
            {
                id: 'bass',
                x: 20, y: 40,
                ...
                shape: 'rect',
                label: 'Bass (60-250Hz)',
                description: 'Body and warmth of instruments. Bass guitar fundamentals, kick drum body. Watch for mud - cut competing frequencies between instruments.'
            },
            {
                id: 'lowmid',
                x: 35, y: 40,
                width: 15, height: 40,
                shape: 'rect',
                label: 'Low-Mids (250-500Hz)',
                description: 'Can sound boxy or warm. Vocals and guitars live here. Small cuts around 300Hz can clean up mixes. Too much = congested sound.'
            },
            {
                id: 'mid',
                x: 50, y: 40,
                width: 15, height: 40,
                shape: 'rect',
                label: 'Mids (500Hz-2kHz)',
                description: 'The most audible range - human ears are most sensitive here. Vocal presence, snare crack, guitar definition. Careful boosting - can fatigue ears.'
            },
            {
                id: 'highmid',
                x: 65, y: 40,
                width: 15, height: 40,
                shape: 'rect',
                label: 'High-Mids (2-6kHz)',
                description: 'Presence and clarity. Vocal intelligibility, guitar bite. The "presence" range. Harsh if overdone - use de-essers around 4-6kHz for vocals.'
            },
            {
                id: 'high',
                x: 80, y: 40,
                ...
                shape: 'rect',
                label: 'Highs (6-20kHz)',
                description: 'Air, sparkle, and sibilance. Cymbals, breath, shimmer. Boost for brightness, cut to reduce harshness. High shelf or air band EQ for sheen.'
            }
        ],
        maskShape: 'circle',
        maskSize: 90,
    },
    {
        ...
        description: 'Follow the signal path from microphone to speakers',
        mode: 'hotspots',
        baseImage: null,
        hotspots: [
            {
                ...
                shape: 'circle',
                label: 'Microphone',
                description: 'Converts acoustic sound to electrical signal. Dynamic mics for loud sources, condenser mics for detail. Polar pattern affects what gets captured.'
            },
            {
                id: 'preamp',
                x: 20, y: 45,
                ...
                shape: 'rect',
                label: 'Preamp',
                description: 'Boosts weak mic signal to line level. Provides phantom power (48V) for condensers. Quality preamps add character; clean preamps stay transparent.'
            },
            {
                id: 'interface',
                x: 38, y: 35,
                ...
                description: 'Converts analog to digital (ADC) and back (DAC). Sample rate and bit depth set here. Buffer size affects latency - lower for recording, higher for mixing.'
            },
            {
                id: 'daw',
                x: 60, y: 35,
                ...
                shape: 'rect',
                label: 'DAW / Computer',
                description: 'Records, edits, and processes audio digitally. Non-destructive editing, unlimited tracks, plugin processing. The creative hub of modern production.'
            },
            {
                id: 'monitors',
                x: 82, y: 45,
                ...
                description: 'Accurate speakers for critical listening. Flat frequency response reveals truth of your mix. Position at ear level, forming equilateral triangle with listening position.'
            }
        ],
        maskShape: 'circle',
        maskSize: 100,
